...
- A compatible device running [Allium][allium], [AmberELEC][amberelec], [Batocera][batocera], [Knulli][knulli], [muOS][muos], [NextUI][nextui], [Onion][onion], [ROCKNIX][rocknix], [Spruce v4][spruce], or [TrimUI][trimui]
...
- [AmberELEC Installation](install-amberelec.md)
