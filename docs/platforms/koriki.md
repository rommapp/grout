...
- **Downloaded games not visible**: After downloading a game through Grout, you will need to refresh the roms list in Koriki for it to appear.

## Platform Mappings

This table shows the mappings of RomM Fs Slug to Koriki's platform folders.
