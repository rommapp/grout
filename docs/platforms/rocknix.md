# ROCKNIX Platform Mappings

This table shows the mappings of RomM Fs Slug to ROCKNIX's platform folders.

| Platform Name                 | RomM Fs Slug               | Folder(s)                   |
|-------------------------------|----------------------------|-----------------------------|
| 3DO Interactive Multiplayer   | 3do                        | 3do                         |
| Amiga                         | amiga                      | amiga, amigacd32            |
...
| TurboGrafx-16                 | tg16                       | pcengine, tg16, tg16cd      |
